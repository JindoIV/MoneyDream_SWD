...
public class JwtUtils : IJwtUtils
{
    ...
    public JwtUtils(IOptions<AppSettings> appSettings)
    {
        ...
        _refreshTokenRepository = new RefrestokenRepository();
    ...
    public string GenerateJwtRefreshToken(string accessToken)
    {
        ...
        try
        {
            ...
            var validateUser = _accountRepository.GetAllAccountByID(userId);
            ...
            var newTokenDescriptor = new SecurityTokenDescriptor
            {
                ...
                new Claim("username", validateUser.UserName.ToString())}
            ),
            ...
            _refreshTokenRepository.Create(validateUser.AccountId, tokenResult);
