    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
    {
        if (!optionsBuilder.IsConfigured)
        {
            IConfigurationRoot configuration = new ConfigurationBuilder()
               ...
               .Build();
            var connectionString = configuration.GetConnectionString("MoneyDream");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Account>(entity =>
        {
            ...
            entity.Property(e => e.Gender)
                .HasMaxLength(50)
                .IsUnicode(false);
            entity.Property(e => e.ImagePublicId).IsUnicode(false);
        ...
        modelBuilder.Entity<ConversationUser>(entity =>
        {
            ...
            entity.Property(e => e.ConversationUserId).HasColumnName("ConversationUserID");
            entity.Property(e => e.AccountId).HasColumnName("AccountID");
            entity.Property(e => e.ConversationId).HasColumnName("ConversationID");
        ...
        {
            entity.HasKey(e => e.ExportId).HasName("PK__ExportIn__E5C997A4E64181C2");
        ...
        {
            entity.HasKey(e => e.ImportId).HasName("PK__ImportIn__8697678A071B880B");
        ...
        {
            entity.HasKey(e => e.SupplierId).HasName("PK__Supplier__4BE66694392ED9FB");
        ...
        {
            entity.HasKey(e => e.UnitId).HasName("PK__Unit__44F5EC9579A44D94");
